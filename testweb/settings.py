...
DEBUG = True
SECRET_KEY = 'django-insecure-q4aw^!i-_%0zl1m@x68s32%4xrf7qk$0f4*=b@wugel8kba^%-'
...
LOGIN_REDIRECT_URL = '/album_list/'  # URL to redirect to after login
...
ALLOWED_HOSTS = ['textbook-reader.onrender.com','127.0.0.1', 'localhost']
